// useRecorder.ts
// Nagrywanie voice note (MediaRecorder; Safari → MP4/AAC).
// Zakres:
//  - czas, blob, stop/cancel
//  - MediaRecorder; Safari → MP4/AAC, reszta webm
// Nowy format: MIME + limit uploadu na backendzie.
// Przy zmianach: MessageInput.tsx, constants/upload.ts.
