// ProfileFields.tsx
// Pola formularza profilu (display name, bio, kolor, avatar).
// Zakres:
//  - wspólne dla setupu i ustawień
//  - display name, bio, kolor, avatar — setup i ustawienia
// Limity: constants/profile.ts.
// Przy zmianach: ProfileSetup.tsx, Panel.tsx, ColorPicker.tsx.
