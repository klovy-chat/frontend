// MyProfile.tsx
// Podgląd własnego profilu (jak widzą inni), opcjonalny szkic z ustawień.
// Zakres:
//  - modal useModal
//  - podgląd „jak widzą inni”; zapis jest w Panel
// Zapis profilu jest w Panel ustawień, nie tutaj.
