// ImageCrop.tsx
// Kadr avatara (koło) / bannera (prostokąt) + limit bajtów.
// Zakres:
//  - slider zoom od min, żeby 1:1 siedział na torze
//  - koło avatar / prostokąt banner + limit bajtów
// Wyjście to Blob/File do addProfileImage — MIME jak upload.ts.
// Przy zmianach: Panel.tsx, ChannelSettings.tsx, constants/upload.ts.
