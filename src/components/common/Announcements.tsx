// Announcements.tsx
// Ogłoszenia serwera (dismiss lokalnie + API).
// Zakres:
//  - lista z controllers/announcements
//  - lista z API, dismiss lokalnie i na serwerze
// Nowe ogłoszenie = dokument Mongo, nie hardcoded.
// Przy zmianach: model/announcements.rs, announcements.css.
