// ChannelSettings.tsx
// Ustawienia kanału: meta, członkowie, mute/ban, zaproszenia.
// Zakres:
//  - tylko admin; roster z HTTP + WS
//  - meta, członkowie, zaproszenia; mute pisz też do muted.ts
// Mute store jest SoT — nie ufaj samemu isMuted z lagującego HTTP.
// Przy zmianach: api/channels.ts, muted.ts, channel/moderation.rs.
