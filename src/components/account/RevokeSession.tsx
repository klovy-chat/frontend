// RevokeSession.tsx
// Potwierdzenie wylogowania jednej sesji.
// Zakres:
//  - revokeSession API
//  - dialog jednej sesji; revoke-all jest w Panel
// Revoke all others jest osobnym przyciskiem w Panel.
// Przy zmianach: Panel.tsx, api/auth.ts.
