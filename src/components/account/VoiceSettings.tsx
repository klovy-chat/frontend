// VoiceSettings.tsx
// Wybór mikrofonu, test, echo — localStorage.
// Zakres:
//  - constraints do getUserMedia
//  - deviceId i echo w localStorage, nie w profilu
// Rozmowa czyta to przez utils/media/voice.ts.
// Przy zmianach: voice.ts, CallContext.tsx.
