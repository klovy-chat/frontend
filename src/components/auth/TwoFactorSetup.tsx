// TwoFactorSetup.tsx
// Włączanie TOTP: QR, kod, backup.
// Zakres:
//  - disable też przez Panel + hasło (step-up)
//  - QR, kod, backup; disable z Panel wymaga hasła
// Sekret nigdy nie idzie do logów.
// Przy zmianach: Panel.tsx, utils/auth/two_factor.rs.
...
import { isSafeOtpauthUrl } from "../../utils/media/allowedMedia";
import "../../styles/auth/two-factor.css";
