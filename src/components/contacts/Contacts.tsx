// Contacts.tsx
// Zakładka znajomych: invite, lista, sent, blocked.
// Zakres:
//  - akcje friends API
//  - invite, lista, sent, blocked — po accept odśwież cache i DM
// Po accept odśwież też friendsCache i listę DM.
// Przy zmianach: api/friends.ts, friendsCache.ts, contacts.css.
