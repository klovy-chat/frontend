...
import type { ResolvedInviteLink } from "../../utils/chat/linkEmbeds";
...
interface ChannelInviteEmbedProps {
  link: ResolvedInviteLink;
}

export function ChannelInviteEmbed({ link }: ChannelInviteEmbedProps) {
