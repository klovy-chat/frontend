...
import { resendPendingOnReconnect } from "../../utils/chat/resendPendingOnReconnect";
...
/**
 * Keeps inactive chat message caches fresh from WS so switching back does not
 * flash stale SWR content until the HTTP revalidate returns.
 * Also owns reconnect scrub/resend while ChatPage is unmounted (Settings/Invite).
 */
export function MessageCacheBridge() {
