// Sticker.tsx
// Picker naklejek — osobna wysyłka (sticker), nie GIF-link.
// Zakres:
//  - Giphy stickers przez backend
//  - osobny typ wiadomości sticker, nie GIF
// Handler onSticker w MessageInput/ChatWindow.
// Przy zmianach: api/stickers.ts, sticker.css.
...
import "../../../styles/pickers/sticker.css";
...
export function Sticker({ onStickerSelect, onClose }: StickerProps) {
