// Gif.tsx
// Picker GIF — wynik to URL, nie upload pliku.
// Zakres:
//  - Giphy przez nasz backend
//  - miniatury; klik = URL do wiadomości, nie plik
// Nie fetchuj Giphy z przeglądarki (CORS/CSP).
// Przy zmianach: MessageInput.tsx, api/gifs.ts, gif.css.
...
export function Gif({ onGifSelect, onClose }: GifProps) {
