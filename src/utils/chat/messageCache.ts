// messageCache.ts
// Pamięć stron czatu: fetchedAt, WS patch bez bumpa świeżości, pending TTL.
// Zakres:
//  - reconnect resend zbiera young pending
//  - nonce > content match
// HTTP revalidate nie może dropować nowszych ramek WS (merge w ChatWindow).
// Przy zmianach: ChatWindow.tsx, MessageCache.tsx, resend.ts, merge.ts.

import type { ChatTarget, Message, MessageUser } from "../../types";
import { mergeMessagePatch } from "./merge";
