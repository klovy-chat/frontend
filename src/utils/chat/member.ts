// member.ts
// Helperzy rosteru kanału (admin, czy ja, lista).
// Zakres:
//  - ChatWindow i settings
//  - admin / czy ja / lista rosteru kanału
// Źródło prawdy członków: snapshot + WS member-left/join w Sidebar.
// Przy zmianach: ChatWindow.tsx, ChannelSettings.tsx.
