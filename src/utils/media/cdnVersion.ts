// cdnVersion.ts
// Query-rewizja po zmianie avatara/bannera.
// Zakres:
//  - bust cache przeglądarki
//  - query-bust po udanym uploadzie zdjęcia
// Bump tylko po udanym uploadzie.
// Przy zmianach: useMediaCache.ts, avatar.ts.
