// allowedMedia.ts
// Hosty dozwolone dla GIF/obrazka-z-URL w dymku.
// Zakres:
//  - reszta = zwykły link
//  - hosty GIF/obrazka-z-URL; reszta = zwykły link
// Nowy CDN GIF: tu + security/urls.rs.
// Przy zmianach: mediaLinks.ts, ExternalMedia.tsx.
