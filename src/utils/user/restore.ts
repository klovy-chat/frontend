// restore.ts
// Po reload: waitBackend + /me → setUser.
// Zakres:
//  - force=true omija cache
//  - waitBackend + /me; współdzielony Promise, force omija cache
// Nie wołaj równolegle z innym restore bez force — Promise jest współdzielony.
// Przy zmianach: AuthContext.tsx, waitBackend.ts.

import * as authApi from "../../api/auth";
import { ApiError, isTransientApiError } from "../../api/client";
import { usesDirectBackendUrl } from "../env/appEnv";
import { waitBackend } from "../env/waitBackend";
